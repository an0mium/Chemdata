...
- [x] BBB predictor tests passing ✓
- [x] Nootropic predictor tests passing ✓
...
- [x] BBB predictor docs complete ✓
- [x] Nootropic predictor docs complete ✓
