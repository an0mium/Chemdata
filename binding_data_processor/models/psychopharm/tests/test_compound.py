...
from binding_data_processor.models.psychopharm.compound import PsychopharmCompound


class TestPsychopharmCompound:
    """Tests for PsychopharmCompound class."""

    def setup_method(self):
        """Set up test instance."""
        self.compound = PsychopharmCompound(
            name="Test Compound",
        ...
        self.compound.add_receptor_binding("5-HT2A", affinity=1.2, confidence=0.9, activity="agonist")
        self.compound.add_receptor_binding("D2", affinity=5.6, confidence=0.8, activity="antagonist")
    ...
    def test_initialization(self):
        """Test initialization of PsychopharmCompound."""
    ...
    def test_update_timestamp(self):
        ...
        self.compound.add_receptor_binding("NEW_RECEPTOR", affinity=1.0, confidence=0.9, activity="agonist")
    ...
    def test_merge_compound_data(self):
        ...
        other.add_receptor_binding("5-HT2A", affinity=1.0, confidence=0.95, activity="partial_agonist")  # Better affinity  # Higher confidence  # Different activity
        other.add_receptor_binding("NMDA", affinity=10.3, confidence=0.7, activity="antagonist")  # New receptor
