...
class TestWebInterface:
    ...
    def test_list_view(self):
        ...
        # Test filtering
        stimulants = self.web.get_compound_list(
            filters={"psychoactive_class": PsychoactiveClass.STIMULANT}
        )
        assert len(stimulants) == 2  # Both are stimulants
        
        high_risk = self.web.get_compound_list(
            filters={"min_risk_level": RiskLevel.HIGH}
        )
